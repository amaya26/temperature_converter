...
class Converter:
    ...
    def __init__(self):
        ...
        # self.all_calculations_list = ['10.0F is -12 C', '20.0F is -7 C', '30.0F is -1 C',
        #                               '40.0F is 4 C', '50.0F is 10 C', '60.0F is 16 C']

        self.all_calculations_list = ['10.0F is -12 C', '20.0F is -7 C', '30.0F is -1 C',
                                      '40.0F is 4 C', '50.0F is 10 C', '60.0F is 16 C', 'This is a test']
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        # create string from calculations list (newest calculation first)
        newest_first_string = ""
        newest_first_list = list(reversed(calculations))

        # last item added in outside the for loop ao that the spacing is correct
